...
public class Spider_Controller : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        self = GameObject.Find("Spider").transform;
    }
    public void FixedUpdate()
    {
        if (target)
        {
            anim.Play("Spider_Walk");
    ...
    public void Die()
    {
        ...
        GetComponent<Spider_Controller>().stop();
        GetComponent<Spider_Controller>().enabled = false;
