...
public class Witch_Movement : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        self = GameObject.Find("Witch").transform;
    }
    public void FixedUpdate()
    {
        if (target)
        {
            anim.Play("Witch_Walk");
    ...
    public void Die()
    {
        ...
        GetComponent<Witch_Movement>().stop();
        GetComponent<Witch_Movement>().enabled = false;
        GetComponent<Collider2D>().enabled = false;
        this.enabled = false;
        anim.Play("Witch_Death");
